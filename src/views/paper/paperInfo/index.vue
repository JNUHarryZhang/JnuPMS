<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="paperList">
      <el-table-column label="论文编号" prop="id" width="100"/>
      <el-table-column label="学号" prop="userName" width="100" />
      <el-table-column label="学生姓名" prop="nickName" :show-overflow-tooltip="true" width="100" />
      <el-table-column label="老师姓名" prop="teacher" :show-overflow-tooltip="true" width="100" />
      <el-table-column label="论文题目" prop="title" width="300" />
      <el-table-column label="课题来源" prop="titleSource" :formatter="sourceFormat" width="110" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="课题来源" prop="titleSource">
          <el-input v-model="form.titleSource" placeholder="请输入课题来源" />
        </el-form-item>
      </el-form>
